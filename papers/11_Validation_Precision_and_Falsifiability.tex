...
\end{verbatim}
with seven passing tests. These tests cover CLI runner behavior, CDFL parsing
and execution, paper-aligned diagnostics, and selected native engine upgrades.

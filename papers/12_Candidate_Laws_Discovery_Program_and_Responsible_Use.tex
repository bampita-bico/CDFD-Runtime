...
Optional LLM provider interpretation does not change that boundary. It may
summarize or question a saved deterministic result, but it is not part of the
engine, not a validator, and not a substitute for domain evidence.

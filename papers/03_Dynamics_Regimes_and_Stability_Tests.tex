...
including regime labels and Part II source-mix functional scores used to test
overload versus retention. These guard toy diagnostics against non-finite values
and keep failure modes visible. A non-finite result is not a discovery. It is a numerical or modeling

...
relationships to CDFL, the CLI, the optional Runtime Studio, and the editor
tooling that makes CDFL inspectable before execution.
...
\end{verbatim}
The first two commands preserve the legacy root aliases; the \texttt{cdfl}
subcommands expose the language workbench explicitly.

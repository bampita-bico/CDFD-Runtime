...
\texttt{diagnostics}, \texttt{cdfl}, \texttt{validate}, \texttt{run},
\texttt{gallery}, \texttt{compare}, \texttt{report}, \texttt{explain},
\texttt{llm}, \texttt{export}, \texttt{auth}), while CDFL models provide a
readable way to define systems and rules. The \texttt{cdfl} subcommand adds
language-facing validation, linting, formatting, AST summaries, and sample
generation without changing the engine equations. \texttt{cdfd.py diagnostics}
writes

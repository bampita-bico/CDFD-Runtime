...
prebiotic parameter space. The selected output
\texttt{experiments/outputs/discovery\_ool\_phase\_results.h5} contains grid
points near $\Lambda=1$. This is useful as a cross-Part-II phase-boundary bridge
and as a test target for the Life Number. It is not empirical proof of abiogenesis.

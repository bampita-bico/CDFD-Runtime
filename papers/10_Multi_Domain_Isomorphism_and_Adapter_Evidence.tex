...
\end{verbatim}
currently lists 196 registered domain keys (May 2026 inventory). Domains include
medicine, physics, origins of life, ecology, economics, climate, infrastructure,
materials science, software engineering, and many more.

This breadth is useful for hypothesis generation. It does not replace
domain-specific validation. The \texttt{origins\_of\_life} adapter exposes
Part II aromatic source-mix diagnostics through
\texttt{cdfd.py demo origins\_of\_life --source-scenario <name>}.
...
perturbations with cross-axis perturbations. In CDFD terms, one drug lowering

...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        prog="cdfd",
        description=(
            "CDFD Runtime CLI — CDFL parse, validate, execute, audit, report, and export."
        ),
        epilog=CLI_EPILOG,
    ...
    doctor_p = sub.add_parser("doctor", help="Check Python, dependencies, examples, and finite-audit support")
    _add_format_args(doctor_p)
    _add_run_bundle_args(doctor_p)

    gallery_p = sub.add_parser("gallery", help="Run the neutral CDFL smoke check")

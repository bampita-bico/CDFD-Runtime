...
class EducationProcess(Process):
    """
    Socioeconomic - Knowledge and skill flow.
    """
    def __init__(self, name="EducationProcess"):
        super().__init__(name)
    ...
    def apply_access_barrier_constraint(self, target: Entity, magnitude: float):
        """
        C = Constraint representing access_barrier.
        """

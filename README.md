...
- `tests/`, `scripts/generate_domain_matrix.py`, and `papers/build_pdfs.sh`:
  release gates for tests, doctor, gallery, compare, reports, packaging,
  generated matrix checks, and PDF presence.

...
class EnvironmentalEngineeringAdapter(DomainAdapter):
    def map_to_engine(self, data):
        processing_efficiency = data.get("processing_efficiency", 0.8)
        ...
        phi = max(processing_efficiency * 0.5 + waste_diversion * 0.5, 0.01)
    ...
    def interpret(self, state):
        ...
        if psi < 0.6:  return "Below standards - processing-capacity constraint"
